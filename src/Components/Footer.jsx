      ...
      <div className='w-full m-auto my-10 md:my-0 md:px-8'>
        ...
        <div className='w-full m-auto flex flex-col md:flex-row justify-between items-center pb-4 md:pb-0 border-2 border-transparent border-b-white'>
          <div className='w-full md:w-1/2'>
            <h1 className='text-2xl md:text-3xl font-bold pb-2'>Dipak Ghadge</h1>
            <p className='pb-4 text-xs md:text-base'>
              "Get in touch for web development insights and projects. Connect with me through social media for updates."
            </p>
          </div>
        ...
        <div className='w-full sm:text-base flex flex-col md:flex-row mt-4'>
          <div className='w-full md:w-1/4 pb-2 sm:pb-0 m-auto md:ml-0 mt-0 flex md:justify-start items-start'>
            <a href="https://www.linkedin.com/in/dipakghadgewebdeveloper" target="_blank" rel="noopener noreferrer" className='text-xl'>
              <BiLogoLinkedin />
            </a>
            <a href="https://github.com/Dipak10016" target="_blank" rel="noopener noreferrer" className='text-xl ml-6'>
              <BiLogoGithub />
            </a>
          </div>
          <div className='w-full md:w-3/4 hidden sm:flex flex-row justify-start md:justify-between lg:justify-end text-start pt-2 md:pt-0 md:pl-4 lg:pl-10'>
            ...
            <Link to='contact' smooth={true} offset={-80} duration={500} className='list-none text-gray-300 pb-3 md:pb-5 pl-7 cursor-pointer'>
              Contact With Me
            </Link>
          </div>
        </div>
