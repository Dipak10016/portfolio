    ...
    <div id='home' className='h-full w-full md:w-[90%] lg:h-[90vh] lg:w-full md:pl-10 lg:pl-0 pt-0 sm:pt-10 lg:py-36 my-10 md:my-20 lg:my-0'>
      <div className='h-full w-full lg:w-3/4 text-center md:text-start'>
        ...
        <p className='text-xs md:text-sm md:w-[65%] lg:w-[50%] text-center md:text-start text-gray-400'>
          Skilled in HTML, CSS, JavaScript, Tailwind CSS, React.js, Node.js, Express.js, and MongoDB. 
          Experienced in state management with Redux Toolkit and Zustand. Proficient in Git, GitHub, Postman, and deployment platforms like Netlify and Render.
        </p>
        ...
        <div className='w-full'>
          <Link 
            ...
            offset={-80} 
            duration={500} 
            className='btn h-10 w-36 mt-5 m-auto md:ml-0 rounded-md flex justify-center items-center text-base font-semibold bg-purple-700 text-white cursor-pointer'
          >
