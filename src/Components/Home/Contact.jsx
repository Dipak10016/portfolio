      ...
      <div className='flex flex-col sm:flex-row justify-between md:px-10'>
        ...
        <div className='h-full w-full sm:w-3/5 lg:w-1/2 sm:pt-8 text-center sm:text-start'>
          ...
          <p className='w-full sm:w-11/12 lg:w-3/4 pb-10 sm:py-4 text-sm'>
            <span className='font-bold text-lg'>Hey there!</span><br />
            Thank you so much for visiting my portfolio and exploring my projects. If you have any thoughts or feedback, I’d love to hear them! Your suggestions would be incredibly helpful as I continue to improve.<br />
            Feel free to drop me a message anytime!<br />
            <span className='text-lg sm:text-xl font-bold'>Thanks for visiting! 😊</span>
          </p>
          <div className='flex justify-start mb-4 sm:my-4'>
            <img src={mail_icon} alt="" className='h-3 w-10 mt-1 cursor-pointer' />
            <p className='sm:px-2 text-sm cursor-pointer'>dipakghadge2004@gmail.com</p>
          </div>
          <div className='flex justify-start my-2 sm:my-4'>
            <img src={call_icon} alt="" className='h-4 w-10 mt-1 cursor-pointer' />
            <p className='sm:px-2 text-sm cursor-pointer'>+91-8010490660</p>
          </div>
          <div className='flex justify-start sm:my-4'>
            <img src={location_icon} alt="" className='h-4 w-10 mt-1 cursor-pointer' />
            <p className='sm:px-2 text-sm cursor-pointer'>Navi Mumbai, India</p>
          </div>
        </div>
        ...
        <form onSubmit={onSubmit} className='h-full w-full sm:w-2/5 lg:w-1/2 mt-10 sm:mt-0'>
          ...
          <div className='flex flex-col'>
            ...
            <input name='email' type='email' value={userEmail} onChange={(e) => setUserEmail(e.target.value)} placeholder='Enter your email' className='h-10 w-full lg:w-4/5 bg-gray-900 pl-3 text-sm border-none outline-none text-white rounded' />
          </div>
          <div className='flex flex-col'>
          ...
          <div className='my-4 sm:my-8'>
            <button type="submit" disabled={submited ? true : false} className={`h-10 w-36 ${submited ? '' : 'btn'} bg-purple-700 rounded-md font-semibold mb-10 text-base`}>
              Submit Now
            </button>
          </div>
        </form>
